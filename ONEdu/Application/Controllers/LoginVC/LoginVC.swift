...
class LoginVC: UIViewController {
    ...
    private var titleLogin: UILabel = {
        let label = UILabel()
    ...
    func setupContraint() {
        ...
        titleLogin.anchor(top: backButton.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 34, paddingLeft: padding, paddingRight: padding)
        desLogin.anchor(top: titleLogin.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 8, paddingLeft: padding, paddingRight: padding)
        titlePhone.anchor(top: desLogin.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 60, paddingLeft: padding, paddingRight: padding)
